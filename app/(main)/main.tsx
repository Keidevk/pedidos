        ...
        <View>
            ...
            <View style={{flexDirection:'row'}}>
                <View style={{backgroundColor:"#E94B64",height:225,width:150,borderRadius:15,marginLeft:10}}>
                    <Image
                    style={{backgroundColor:"#ccc",height:115,margin:12,borderRadius:10}}
                    ></Image>
                    <Text style={{color:'white',marginLeft:10,fontFamily:'Inter_300Light'}}>Shop</Text>
                    <Text style={{color:'white',marginLeft:10,fontFamily:'Inter_300Light'}}>Product Title</Text>
                    <Text style={{color:'white',marginLeft:10,fontFamily:'Inter_400Regular'}}>Price</Text>
                </View>
                <View style={{backgroundColor:"#E94B64",height:225,width:150,borderRadius:15,marginLeft:10}}>
                    <Image
                    style={{backgroundColor:"#ccc",height:115,margin:12,borderRadius:10}}
